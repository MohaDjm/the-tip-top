        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <button 
              ...
              className="w-full h-12 border-2 border-gray-200 rounded-lg font-['Lato'] font-medium text-gray-700 hover:border-[#D4B254] hover:bg-[#F5F1E6] transition-all duration-200 flex items-center justify-center space-x-3"
            >
