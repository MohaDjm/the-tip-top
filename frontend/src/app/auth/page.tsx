      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <button 
              disabled
              className="w-full h-12 border-2 border-gray-300 rounded-lg font-['Lato'] font-medium text-gray-400 cursor-not-allowed flex items-center justify-center space-x-3"
            >
